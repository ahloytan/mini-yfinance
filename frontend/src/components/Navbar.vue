...
<nav class="bg-gray-800">
      ...
      <div class="relative flex h-16 items-center justify-between">
        ...
        <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
          <button type="button" class="relative rounded-full bg-gray-800 p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
            <a href="https://www.youtube.com/watch?v=fcZXfoB2f70&ab_channel=RickrollNoads" target="_blank"><span class="absolute -inset-1.5"></span></a>
          ...
          <div class="relative ml-3">
            <div>
              <button type="button" class="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                <a href="https://magiceden.io/item-details/polygon/0x50d2915927255109570d9f72ebeb8cb477df508e/277"  target="_blank"><span class="absolute -inset-1.5"></span></a>
    ...
    <div v-show="isVisible" id="mobile-menu">
      <div class="space-y-1 px-2 pb-3 pt-2">
        ...
        <a href="https://ahloytan.netlify.app" target="_blank" :class="activeLink('/portfolio')" class="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-base font-medium">Portfolio</a>
      </div>
    </div>
  </nav>
</template>  
